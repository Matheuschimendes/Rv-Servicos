    ...
    <section id="beneficios-gestores" className="py-24 md:py-32 bg-brand-surface relative overflow-hidden">
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="flex flex-col lg:flex-row gap-16 lg:gap-20 items-start lg:items-center">
          ...
          <div className="w-full lg:w-7/12 grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-5 md:gap-8">
            {managerFeatures.map((f, i) => (
              ...
              >
                ...
                <div className="pl-3 sm:pl-4 md:pl-6">
                  ...
                  <div className="mt-4 sm:mt-5 md:mt-6 pt-1 flex items-center text-[10px] uppercase tracking-[0.25em] sm:tracking-[0.3em] text-brand-dark/60 font-bold">
